...
namespace AomiToDB.Data
{
 ...
 "Warning"
        ...
        static DataConnection()
        {
            ...
            AomiToDB.DataProvider.Access.AccessTools.GetDataProvider();
            AomiToDB.DataProvider.SqlCe.SqlCeTools.GetDataProvider();
            AomiToDB.DataProvider.Firebird.FirebirdTools.GetDataProvider();
            AomiToDB.DataProvider.MySql.MySqlTools.GetDataProvider();
            AomiToDB.DataProvider.SQLite.SQLiteTools.GetDataProvider();
            AomiToDB.DataProvider.Sybase.SybaseTools.GetDataProvider();
            AomiToDB.DataProvider.Oracle.OracleTools.GetDataProvider();
            AomiToDB.DataProvider.PostgreSQL.PostgreSQLTools.GetDataProvider();
            AomiToDB.DataProvider.DB2.DB2Tools.GetDataProvider();
            AomiToDB.DataProvider.Informix.InformixTools.GetDataProvider();
            AomiToDB.DataProvider.SapHana.SapHanaTools.GetDataProvider();
            AomiToDB.DataProvider.SqlServer.SqlServerTools.GetDataProvider();
